...
with st.sidebar:
    ...
    with col1:
        ...
        st.write("")
        st.image("/Users/dextercyberlabs/Desktop/MCP_Server/KOcSmocdGnzvktHgUvq9DEjYAU.png", width=65)
    with col2:
...
with col1:
    ...
    st.markdown("<div style='display: flex; align-items: center; gap: 10px;'><span style='font-size: 28px; color: #666;'>Powered by LlamaIndex</span><img src='data:image/png;base64,{}' width='50'></div>".format(
        base64.b64encode(open("/Users/dextercyberlabs/Desktop/MCP_Server/ChatGPT Image Jun 18, 2025 at 12_57_35 PM.png", "rb").read()).decode()
